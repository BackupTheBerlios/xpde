...
begin
    ...
    if verb=iSharingandSecurity then RunSharingSecurityDlg(FPath+'/');

    if verb=iProperties then RunPropertiesDlg(FPath+'/',getIcon , false);
end;
...
begin
    ...
    if verb=iProperties then RunPropertiesDlg(FPath, getIcon, true);
end;
